...
class Indicator(BaseModel):
    ...
    def __str__(self):
        ...
        return f'Oferta de la categoría {self.category_product}: {self.disccount_value}%'
...
class Product(BaseModel):
    ...
    description = models.TextField('Descripción producto', unique=True, blank=False, null=False)
    ...
    category_product = models.ForeignKey(CategoryProduct, on_delete=models.CASCADE, verbose_name='Categoría Producto', null=True)
    historical = HistoricalRecords()
